...
public class BucketMaterial
{
     ...
     * @return
     */
    public boolean allowInteractionOfEntity(EntityRegistry.EntityRegistration entry)
    {
        return entityInteractionAllowList ? entityInteractionList.contains(entry.getEntityName()) : !entityInteractionList.contains(entry.getEntityName());
    }
